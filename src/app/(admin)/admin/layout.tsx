  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col gap-4 px-3 py-10 sm:gap-6 sm:px-6">
        <header className="rounded-xl border border-slate-800 bg-slate-900/60 p-3 shadow-lg sm:p-6">
        ...
        <main className="rounded-xl border border-slate-800 bg-slate-900/40 p-3 shadow-lg sm:p-6">
          {children}
        </main>
      </div>
    </div>
